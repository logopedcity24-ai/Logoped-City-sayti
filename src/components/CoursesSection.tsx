                ...
                <div>
                  ...
                  <div className="space-y-2 py-3 border-y border-slate-100 text-xs text-slate-700">
                    <div className="flex items-center space-x-2">
                      ...
                      <span><strong>{t.courses.durationLabel}</strong> {duration}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <BookOpen className="w-4 h-4 text-teal-600 shrink-0" />
                      <span><strong>{t.courses.targetLabel}</strong> {targetAudience}</span>
                    </div>
                    {course.certificate && (
                      <div className="flex items-center space-x-2 text-emerald-700 font-semibold">
                        <Award className="w-4 h-4 text-emerald-600 shrink-0" />
                        <span>{language === 'uz' ? 'Rasmiy sertifikat beriladi' : 'Выдается официальный сертификат'}</span>
                      </div>
                    )}
                  </div>
