...
export const BRANCHES: Branch[] = [
  {
    ...
    city: 'Urganch shahri',
    cityRu: 'город Ургенч',
    address: 'Bo‘ston ko‘chasi, 1-uy',
    addressRu: 'ул. Бустон, дом 1',
    landmark: 'Bo‘ston ko‘chasi, 1-uy',
    landmarkRu: 'ул. Бустон, дом 1',
    ...
    mapUrl: 'https://maps.google.com/?q=41.536587,60.634544',
    yandexMapUrl: 'https://yandex.uz/maps/?whatshere%5Bpoint%5D=60.634544%2C41.536587&whatshere%5Bzoom%5D=17.5&ll=60.634544%2C41.536587&z=17.5',
    yandexNaviUrl: 'https://yandex.uz/maps/?rtext=~41.536587,60.634544&rtt=auto',
    coords: { lat: 41.536587, lng: 60.634544 },
    hasCBO: false,
...
export const SPECIALISTS: Specialist[] = [
  {
    id: 'spec-aziza',
    name: 'Atadjanova Aziza Baxtiyarovna',
  ...
  {
    id: 'spec-sojida',
    name: 'Palvonova Sojida Jur’atbekovna',
    nameRu: 'Пальвонова Сожида Джуратбековна',
    role: 'Defektolog-Logoped, Sensor Integratsiya Mutaxassisi',
    roleRu: 'Дефектолог-логопед, специалист по сенсорной интеграции',
    experience: 'Oliy ma’lumotli davlat attestatsiyasidan o‘tgan mutaxassis',
    experienceRu: 'Дипломированный специалист с государственной аттестацией',
  ...
  },
  {
    ...
    role: 'Defektolog-Logoped, ABA Terapevt, Ergoterapiya Mutaxassisi',
    roleRu: 'Дефектолог-логопед, АВА-терапевт, эрготерапевт',
    experience: 'Oliy ma’lumotli mutaxassis, diplomli defektolog-logoped',
    experienceRu: 'Дипломированный специалист с высшим образованием',
  ...
  },
  {
    ...
    role: 'Defektolog-Logoped, ABA Terapevt',
    roleRu: 'Дефектолог-логопед, АВА-терапевт',
    experience: 'Oliy ma’lumotli defektolog-logoped, sertifikatlangan mutaxassis',
  ...
  {
    id: 'spec-dildora',
    name: 'Sultonnazirova Dildora',
    nameRu: 'Султонназирова Дилдора',
  ...
  },
  {
    ...
    role: 'Sensor Integratsiya Mutaxassisi',
    roleRu: 'Специалист по сенсорной интеграции',
...
export const CERTIFICATES: CertificateItem[] = [
  // ==================== ATADJANOVA AZIZA BAXTIYAROVNA (13 ta) ====================
  {
    id: 'cert-aziza-magistratura-diplom',
    specialistId: 'spec-aziza',
    specialistName: 'Atadjanova Aziza Baxtiyarovna',
  ...
  {
    id: 'cert-aziza-aba-3-modul-ertz',
    specialistId: 'spec-aziza',
    specialistName: 'Atadjanova Aziza Baxtiyarovna',
    specialistNameRu: 'Атаджанова Азиза Бахтияровна',
    specialistRole: 'Logoped City Kuratori, Defektolog, ABA Terapevt',
    specialistRoleRu: 'Куратор Logoped City, Дефектолог, АВА-терапевт',
    title: 'Amaliy xulq-atvor tahlili (ABA) 3-modul: Funktsional tahlil va korreksiya',
    titleRu: 'Прикладной анализ поведения (АВА) Модуль 3: Функциональный анализ и коррекция',
    type: 'certificate',
    issuer: 'Школа Юлии Эрц (МА, BCBA) (Sertifikat № 201883-2347-90349)',
    issuerRu: 'Школа Юлии Эрц (МА, BCBA) (Сертификат № 201883-2347-90349)',
    issueDate: '60 o‘quv soati, 12.04.2026',
    imageUrl: '/certificates/aziza-atajanova-aba-3-modul-ertz.jpg',
    description: '«Функциональный анализ и методы коррекции поведения» xalqaro sertifikatsiyalangan 3-modul kursi va amaliy treningini muvaffaqiyatli tamomlaganlik to‘g‘risida sertifikat.',
    descriptionRu: 'Международный сертификат об успешном окончании 3-го модуля «Функциональный анализ и методы коррекции поведения» под руководством Юлии Эрц (60 часов).',
    badge: 'ABA 3-Modul (BCBA)',
    badgeRu: 'АВА 3-Модуль (BCBA)'
  },

  // ==================== SULTONOVA SHOIRA DAVRONBEK QIZI (16 ta) ====================
  {
  ...
  {
    id: 'cert-shoira-logoped-city-kurs-dispraksiya',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектолог, логопед, АВА-терапевт',
    title: 'Logopediya kursi: «Artikulyatsion dispraksiya, dizartriya, tizimli nutq buzilish va umumiy tashxislash»',
    titleRu: 'Курс логопедии: «Артикуляционная диспраксия, дизартрия, системные нарушения речи и общая диагностика»',
    type: 'certificate',
    issuer: '«LOGOPED CITY» M.Ch.J. (Sertifikat № 000037, Litsenziya № 1427720)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000037, Лицензия № 1427720)',
    issueDate: '72 soat (Kurs rahbari: Aziza Atadjanova)',
    imageUrl: '/certificates/shoira-sultonova-logoped-city-kurs-dispraksiya.jpg',
    description: 'Logoped City markazida 72 soatlik nazariy va amaliy malaka oshirish kursini muvaffaqiyatli tamomlaganlik to‘g‘risida rasmiy sertifikat.',
    descriptionRu: 'Сертификат об успешном окончании 72-часового курса повышения квалификации по коррекции диспраксии, дизартрии и системных нарушений речи в Logoped City.',
    badge: 'Logoped City (72 soat)',
    badgeRu: 'Logoped City (72 ч)'
  },
  {
    id: 'cert-shoira-logoped-city-kurs-neyropodxod',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектолог, логопед, АВА-терапевт',
    title: 'Logopediya kursi: «Ekspressiv va impressiv nutq buzilishlari, nutq eshitish agnoziyasi, neyropodxod»',
    titleRu: 'Курс логопедии: «Экспрессивные и импрессивные нарушения речи, речевая слуховая агнозия, нейроподход»',
    type: 'certificate',
    issuer: '«LOGOPED CITY» M.Ch.J. (Sertifikat № 000032, Litsenziya № 1427720)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000032, Лицензия № 1427720)',
    issueDate: '72 soat (Kurs rahbari: Aziza Atadjanova)',
    imageUrl: '/certificates/shoira-sultonova-logoped-city-kurs-neyropodxod.jpg',
    description: 'Logoped City markazida ekspressiv va impressiv nutq buzilishlarini faollashtirish hamda neyroyondashuv bo‘yicha 72 soatlik kurs sertifikati.',
    descriptionRu: 'Сертификат 72-часового курса по нейроподходу в логопедии, слуховой агнозии и активации экспрессивной и импрессивной речи.',
    badge: 'Logoped City (72 soat)',
    badgeRu: 'Logoped City (72 ч)'
  },
  {
    id: 'cert-shoira-logoped-city-nutqsiz-bolalar',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектолог, логопед, АВА-терапевт',
    title: 'Nutqsiz bolalarda hamkorlik va nutqni uyg‘otish maxsus seminar-treningi',
    titleRu: 'Семинар-тренинг: «Сотрудничество и запуск речи у неговорящих детей»',
    type: 'certificate',
    issuer: '«LOGOPED CITY» M.Ch.J. (Sertifikat № 0000130, Litsenziya № 1427720)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 0000130, Лицензия № 1427720)',
    issueDate: '19.04.2026 (Kurs rahbari: Aziza Atadjanova)',
    imageUrl: '/certificates/shoira-sultonova-logoped-city-nutqsiz-bolalar.jpg',
    description: 'Nutqsiz va muloqotga kirishmaydigan bolalarda pedagogik hamkorlik o‘rnatish va nutqni faollashtirish usullari bo‘yicha seminar sertifikati.',
    descriptionRu: 'Сертификат семинара-тренинга по установлению сотрудничества и методикам запуска речи у неговорящих детей.',
    badge: 'Nutqni Uyg‘otish',
    badgeRu: 'Запуск речи'
  },
  {
    id: 'cert-shoira-tualet-trening',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    ...
    titleRu: 'Специальный тренинг по туалетному навыку и гигиене у детей',
    type: 'certificate',
    issuer: 'Logoped City Bolalar Rivojlanish Markazi (Atadjanova Aziza Baxtiyarovna)',
    issuerRu: 'Детский развивающий центр Logoped City (Атаджанова Азиза Бахтияровна)',
    issueDate: '13.02.2025',
    imageUrl: '/certificates/shoira-sultonova-tualet-trening.jpg',
    description: 'Rivojlanishida o‘ziga xosligi bo‘lgan bolalarda kundalik hayotiy va mustaqil gigiyenik ko‘nikmalarni shakllantirish bo‘yicha 2 soatlik maxsus trening.',
    descriptionRu: 'Сертификат практического тренинга по формированию жизненно важных навыков самообслуживания и туалетного тренинга.',
    badge: 'Amaliy Trening',
    badgeRu: 'Практический тренинг'
  },
  {
    id: 'cert-shoira-miyacha-stimulyatsiyasi',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектолог, логопед, АВА-терапевт',
    title: 'Miyacha stimulyatsiyasi (autizm, ZPR, duduqlanish, alaliya) da qo‘llash metodikasi (1 modul)',
    titleRu: 'Методика мозжечковой стимуляции при аутизме, ЗПР, заикании и алалии (1 модуль)',
    type: 'certificate',
    issuer: '«Академия речи Шутовой» & «Логопеды Узбекистана» (Azizova S.F.)',
    issuerRu: '«Академия речи Шутовой» и «Логопеды Узбекистана» (Азизова С.Ф.)',
    issueDate: '2025-yil',
    imageUrl: '/certificates/shoira-sultonova-miyacha-stimulyatsiyasi.jpg',
    description: 'Miyacha stimulyatsiyasi va neyromashqlar orqali autizm, nutq tutilishi (duduqlanish) hamda alaliyani korreksiya qilish dasturi sertifikati.',
    descriptionRu: 'Сертификат 1-го модуля по применению мозжечковой стимуляции и нейрокоррекции при аутизме, заикании, ЗПР и алалии.',
    badge: 'Miyacha Stimulyatsiyasi',
    badgeRu: 'Мозжечковая стимуляция'
  },
  {
    id: 'cert-shoira-vb-mapp-protokol',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    ...
    titleRu: 'Целевая работа на основе универсального протокола VB-MAPP',
    type: 'certificate',
    issuer: '«Autizm va Mehr» Markazi (Rasulov Islom)',
    issuerRu: 'Центр «Autizm va Mehr» (Расулов Ислом)',
    issueDate: '27.06.2026',
    imageUrl: '/certificates/shoira-sultonova-vb-mapp-protokol.jpg',
    description: 'Bolaning nutqiy va ijtimoiy ko‘nikmalarini VB-MAPP xalqaro protokoli asosida bosqichma-bosqich rivojlantirish kursi sertifikati.',
    descriptionRu: 'Сертификат участника курса по целенаправленному развитию речевых и поведенческих навыков по протоколу VB-MAPP.',
    badge: 'VB-MAPP Protokoli',
    badgeRu: 'Протокол VB-MAPP'
  },
  {
    id: 'cert-shoira-muammoli-xulq-atvor',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектолог, логопед, АВА-терапевт',
    title: 'Muammoli xulq-atvor bilan ishlash va hamkorlik qilish amaliy seminari',
    titleRu: 'Практический семинар: «Работа с проблемным поведением и сотрудничество»',
    type: 'certificate',
    issuer: '«Autizm va Mehr» Markazi (Rasulov Islom)',
    issuerRu: 'Центр «Autizm va Mehr» (Расулов Ислом)',
    issueDate: '25.06.2026',
    imageUrl: '/certificates/shoira-sultonova-muammoli-xulq-atvor.jpg',
    description: 'Autizm va nutqiy buzilishlari bo‘lgan bolalarda nomaqbul xulq-atvorni kamaytirish va ijobiy hamkorlik o‘rnatish bo‘yicha maxsus seminar sertifikati.',
    descriptionRu: 'Сертификат семинара по коррекции нежелательного поведения и формированию сотрудничества у детей с аутизмом.',
    badge: 'Xulq-atvor Korreksiyasi',
    badgeRu: 'Коррекция поведения'
  },
  {
    id: 'cert-shoira-problematik-xulq-hamkorlik',
    specialistId: 'spec-shoira',
    specialistName: 'Sultonova Shoira Davronbek qizi',
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    ...
    titleRu: 'Семинар: «Работа с проблематичным поведением и создание сотрудничества»',
    type: 'certificate',
    issuer: '«Autizm va Mehr» Markazi (Rasulov Islom)',
    issuerRu: 'Центр «Autizm va Mehr» (Расулов Ислом)',
    issueDate: '01.03.2025',
    imageUrl: '/certificates/shoira-sultonova-problematik-xulq-hamkorlik.jpg',
    description: 'Maxsus ehtiyojli bolalarda xulq-atvor omillarini baholash va muvaffaqiyatli pedagogik aloqa o‘rnatish usullari bo‘yicha seminar.',
    descriptionRu: 'Сертификат семинара по оценке факторов поведения и выстраиванию педагогического взаимодействия.',
    badge: 'Hamkorlik Yaratish',
    badgeRu: 'Сотрудничество'
  },
  {
  ...
  },
  {
    ...
    specialistNameRu: 'Султанова Шоира Давронбековна',
    specialistRole: 'Pedagog-Defektolog, Logoped, ABA Terapevt',
    specialistRoleRu: 'Педагог-дефектоlog, логопед, АВА-терапевт',
  ...
  },
  {
    ...
    type: 'certificate',
    issuer: 'Med City Klinikasi (Shakarov A., Qurbonov R., Solayeva S., Atadjanova A.)',
  ...
  // ==================== PALVANOVA SOJIDA JUR'ATBEKOVNA (5 ta) ====================
  {
    ...
    specialistName: 'Palvonova Sojida Jur’atbekovna',
    specialistNameRu: 'Пальвонова Сожида Джуратбековна',
    specialistRole: 'Defektolog-Logoped, Sensor Integratsiya Mutaxassisi',
    specialistRoleRu: 'Дефектолог-логопед, специалист по сенсорной интеграции',
    title: 'Davlat Oliy Ma’lumot Diplomi: Pedagog-Defektolog (Logopediya)',
    titleRu: 'Государственный диплом бакалавра: Педагог-дефектолог (Логопедия)',
    type: 'diploma',
    issuer: 'Ajiniyoz nomidagi Nukus Davlat Pedagogika Instituti',
  ...
  // ==================== SODIQJONOVA YOQUTJON (6 ta) ====================
  {
    ...
    specialistRole: 'Defektolog-Logoped, ABA Terapevt, Ergoterapiya Mutaxassisi',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт, эрготерапевт',
  ...
  // ==================== SULTONNAZIROVA DILDORA (4 ta) ====================
  {
    id: 'cert-dildora-aba-smart-ibao',
    specialistId: 'spec-dildora',
    specialistName: 'Sultonnazirova Dildora',
    specialistNameRu: 'Султонназирова Дилдора',
  ...
  // ==================== OLIMOVA DILNURA (10 ta) ====================
  {
    ...
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Bolalarda mustaqil gigiyena: Tualet treningi maxsus amaliy kursi',
  ...
  },
  {
    ...
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Oliy ma’lumot to‘g‘risida Davlat Diplomi: Defektologiya (Logopediya)',
    titleRu: 'Государственный диплом бакалавра: Дефектология (Логопедия)',
    type: 'diploma',
    issuer: 'Navoiy Davlat Universiteti (№ 00639203)',
    issuerRu: 'Навоийский Государственный Университет (№ 00639203)',
    issueDate: '19-mart 2025-yil',
    imageUrl: '/certificates/dilnura-olimova-diplom.jpg',
    description: 'Defektologiya (logopediya) ta’lim yo‘nalishi bo‘yicha davlat attestatsiyasi qaroriga binoan Bakalavr darajasi va mutaxassislik diplomi.',
    descriptionRu: 'Диплом о высшем образовании по направлению «Дефектология (логопедия)» с присвоением квалификации бакалавра.',
    badge: 'Davlat Bakalavr Diplomi',
    badgeRu: 'Диплом бакалавра'
  },
  {
  ...
  {
    id: 'cert-dilnura-muammoli-xulq-atvor',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Muammoli xulq-atvor bilan ishlash va hamkorlik qilish',
    titleRu: 'Работа с проблемным поведением и сотрудничество',
    type: 'certificate',
    issuer: '«Autizm va Mehr» (Rasulov Islom)',
    issuerRu: '«Autizm va Mehr» (Расулов Ислом)',
    issueDate: '25.06.2026',
    imageUrl: '/certificates/dilnura-olimova-muammoli-xulq-atvor.jpg',
    description: 'Bolalarda nomaqbul xulq-atvor shakllarini korreksiya qilish, ijobiy mustahkamlash va o‘rganishga bo‘lgan hamkorlikni shakllantirish bo‘yicha seminar.',
    descriptionRu: 'Практический семинар по коррекции нежелательного поведения и формированию навыков учебного сотрудничества.',
    badge: 'Xulq-atvor Korreksiyasi',
    badgeRu: 'Коррекция поведения'
  },
  {
    id: 'cert-dilnura-vb-mapp',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'VB-MAPP universal protokoliga asoslanib maqsadli ishlash',
    titleRu: 'Целевая работа по универсальному протоколу VB-MAPP',
    type: 'certificate',
    issuer: '«Autizm va Mehr» (Rasulov Islom)',
    issuerRu: '«Autizm va Mehr» (Расулов Ислом)',
    issueDate: '27.06.2026',
    imageUrl: '/certificates/dilnura-olimova-vb-mapp.jpg',
    description: 'Nutqiy va verbal ko‘nikmalarni baholashning universal VB-MAPP protokoli asosida individual ta’lim maqsadlarini belgilash kursi.',
    descriptionRu: 'Курс по методике универсального протокола VB-MAPP для оценки речевых навыков и составления программы вмешательства.',
    badge: 'VB-MAPP Protokoli',
    badgeRu: 'Протокол VB-MAPP'
  },
  {
    id: 'cert-dilnura-logo-bilim-asoslari',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Logopediya asoslari: diagnostika va amaliy korreksiya',
    titleRu: 'Основы логопедии: диагностика и практика коррекции',
    type: 'certificate',
    issuer: 'Logo-Bilim o‘quv markazi (Isroilova Sokina)',
    issuerRu: 'Учебный центр Logo-Bilim (Исроилова Сокина)',
    issueDate: '2024-yil',
    imageUrl: '/certificates/dilnura-olimova-logo-bilim-asoslari.jpg',
    description: 'Artikulyatsion apparat anatomiyasi, tovushlar talaffuzini qo‘yish, logopedik tekshiruv va differensial tashxis asoslari.',
    descriptionRu: 'Курс основ логопедии: анатомия артикуляционного аппарата, постановка звуков и дифференциальная диагностика.',
    badge: 'Logo-Bilim',
    badgeRu: 'Logo-Bilim'
  },
  {
    id: 'cert-dilnura-logoped-city-kurs-1',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Boshlang‘ich logopediya kursi (1-modul, 72 soat)',
    titleRu: 'Начальный курс логопедии (1 модуль, 72 часа)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000012)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000012)',
    issueDate: '72 soat, 30.03.2026',
    imageUrl: '/certificates/dilnura-olimova-logoped-city-kurs-1.jpg',
    description: 'Logopedik korreksiya, tovushlar buzilishi diagnostikasi va intensiv logopedik mashqlar texnikasi bo‘yicha malaka oshirish sertifikati.',
    descriptionRu: 'Сертификат повышения квалификации: диагностика нарушений звукопроизношения и техники логопедических занятий.',
    badge: 'Logoped City (72s)',
    badgeRu: 'Logoped City (72ч)'
  },
  {
    id: 'cert-dilnura-logoped-city-kurs-2',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Boshlang‘ich defektologiya kursi (1-modul, 72 soat)',
    titleRu: 'Начальный курс дефектологии (1 модуль, 72 часа)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000026)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000026)',
    issueDate: '72 soat, 30.03.2026',
    imageUrl: '/certificates/dilnura-olimova-logoped-city-kurs-2.jpg',
    description: 'Rivojlanishida nuqsoni bo‘lgan bolalar bilan ishlash, psixofizik rivojlanish bosqichlari va korreksion pedagogika metodlari.',
    descriptionRu: 'Курс основ дефектологии: этапы психофизического развития детей и современные коррекционные методики.',
    badge: 'Defektologiya (72s)',
    badgeRu: 'Дефектология (72ч)'
  },
  {
    id: 'cert-dilnura-nutqsiz-bolalar-uygotish',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Nutqsiz bolalarda hamkorlik va nutqni uyg‘otish',
    titleRu: 'Сотрудничество и запуск речи у неговорящих детей',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 0000136)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 0000136)',
    issueDate: '19.04.2026',
    imageUrl: '/certificates/dilnura-olimova-nutqsiz-bolalar-uygotish.jpg',
    description: 'Nutqsiz bolalarda kommunikativ motivatsiya, taqlid va nutq faolligini uyg‘otish bo‘yicha amaliy mahorat darsi.',
    descriptionRu: 'Практический мастер-класс по формированию мотивации общения, подражанию и запуску речи у неговорящих детей.',
    badge: 'Nutqni uyg‘otish',
    badgeRu: 'Запуск речи'
  },
  {
    id: 'cert-dilnura-navoiy-dpi-defektologiya',
    specialistId: 'spec-dilnura',
    specialistName: 'Olimova Dilnura Raximberganovna',
    specialistNameRu: 'Олимова Дилнура Рахимбергановна',
    specialistRole: 'Defektolog-Logoped, ABA Terapevt',
    specialistRoleRu: 'Дефектолог-логопед, АВА-терапевт',
    title: 'Defektologiya fani va uning mazmun-mohiyati ilmiy seminari',
    titleRu: 'Научный семинар по основам дефектологии',
    type: 'certificate',
    issuer: 'Navoiy Davlat Pedagogika Instituti',
    issuerRu: 'Навоийский Государственный Педагогический Институт',
    issueDate: '31.10.2021',
    imageUrl: '/certificates/dilnura-olimova-navoiy-dpi-defektologiya.jpg',
    description: 'Maxsus pedagogika va inklyuziv ta’limning dolzarb masalalari bo‘yicha ilmiy-amaliy seminarda ishtirok etganligi haqida sertifikat.',
    descriptionRu: 'Сертификат участия в научно-практическом семинаре по актуальным вопросам специальной педагогики и инклюзивного образования.',
    badge: 'Ilmiy Seminar',
    badgeRu: 'Научный семинар'
  },

  // ==================== JUMANIYOZOVA NODIRA ISMOIL QIZI (5 ta) ====================
  {
  ...
  {
    id: 'cert-nodira-logos-konferensiya',
    specialistId: 'spec-nodira',
    specialistName: 'Jumaniyozova Nodira Ismoil qizi',
    specialistNameRu: 'Жуманиёзова Нодира Исмоил кизи',
    specialistRole: 'Maxsus pedagog (o‘qituvchi-logoped)',
    specialistRoleRu: 'Специальный педагог (учитель-логопед)',
    title: 'Yangi O‘zbekiston nigohida: Bolalarni tashxislash, korreksiyalash va reabilitatsiyasi',
    titleRu: 'Диагностика, коррекция и реабилитация детей с нарушениями развития',
    type: 'certificate',
    issuer: 'Logos markazi & II Respublika Ilmiy-Amaliy Konferensiyasi (Toshkent)',
    issuerRu: 'Центр Logos и II Республиканская научно-практическая конференция (Ташкент)',
    issueDate: 'Toshkent, 2024-yil',
    imageUrl: '/certificates/nodira-jumaniyozova-logos-konferensiya.jpg',
    description: 'Rivojlanishida nuqsoni bo‘lgan bolalarni zamonaviy tashxislash, korreksiyalash va reabilitatsiya qilish bo‘yicha respublika ilmiy konferensiyasi.',
    descriptionRu: 'Сертификат участия во II Республиканской научно-практической конференции по диагностике, коррекции и реабилитации детей.',
    badge: 'Logos Konferensiya',
    badgeRu: 'Конференция Logos'
  },
  {
    id: 'cert-nodira-harakat-nutq-vpf',
    specialistId: 'spec-nodira',
    specialistName: 'Jumaniyozova Nodira Ismoil qizi',
    specialistNameRu: 'Жуманиёзова Нодира Исмоил кизи',
    specialistRole: 'Maxsus pedagog (o‘qituvchi-logoped)',
    specialistRoleRu: 'Специальный педагог (учитель-логопед)',
    title: 'Развитие речи и ВПФ через движение и ощущения',
    titleRu: 'Развитие речи и ВПФ через движение и ощущения',
    type: 'certificate',
    issuer: 'Logo F-Step, Oq Bulutcha & Respublika bolalar ijtimoiy moslashuvi markazi',
    issuerRu: 'Logo F-Step, Oq Bulutcha и Республиканский центр социальной адаптации детей',
    issueDate: '2024-yil',
    imageUrl: '/certificates/nodira-jumaniyozova-harakat-nutq-vpf.jpg',
    description: 'Sensor harakatlar va his-tuyg‘ular orqali oliy psixik funksiyalar hamda nutqni rivojlantirish bo‘yicha amaliy trening kursi.',
    descriptionRu: 'Практический тренинг по развитию речи и высших психических функций через движение, сенсорную интеграцию и ощущения.',
    badge: 'Harakat va Nutq (VPF)',
    badgeRu: 'Движение и Речь (ВПФ)'
  },
  {
    id: 'cert-nodira-nutqsiz-bolalar-uygotish',
    specialistId: 'spec-nodira',
    specialistName: 'Jumaniyozova Nodira Ismoil qizi',
    specialistNameRu: 'Жуманиёзова Нодира Исмоил кизи',
    specialistRole: 'Maxsus pedagog (o‘qituvchi-logoped)',
    ...
    titleRu: 'Сотрудничество и запуск речи у неговорящих детей',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 0000131)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 0000131)',
    issueDate: '19.04.2026',
    imageUrl: '/certificates/nodira-jumaniyozova-nutqsiz-bolalar-uygotish.jpg',
    description: 'Kommunikatsiyaga kirmaydigan va nutqsiz bolalarda dastlabki nutq signallarini uyg‘otish hamda hamkorlik o‘rnatish mahorat darsi.',
    descriptionRu: 'Мастер-класс по запуску речи и установлению продуктивного сотрудничества с неговорящими детьми.',
    badge: 'Nutqni uyg‘otish',
    badgeRu: 'Запуск речи'
  },
  {
    id: 'cert-nodira-neurologopediya',
    specialistId: 'spec-nodira',
    specialistName: 'Jumaniyozova Nodira Ismoil qizi',
    specialistNameRu: 'Жуманиёзова Нодира Исмоил кизи',
    specialistRole: 'Maxsus pedagog (o‘qituvchi-logoped)',
    specialistRoleRu: 'Специальный педагог (учитель-логопед)',
    title: 'Nutq nuqsonlarini tashxislash va bartaraf etish (Neurologopediya)',
    titleRu: 'Диагностика и устранение речевых нарушений (Курс неврологопедии)',
    type: 'certificate',
    issuer: 'PhD Z. Salixova (Sertifikat № 674750)',
    issuerRu: 'PhD З. Салихова (Сертификат № 674750)',
    issueDate: '8 haftalik chuqurlashtirilgan kurs',
    imageUrl: '/certificates/nodira-jumaniyozova-neurologopediya.jpg',
    description: 'Murakkab nutq buzilishlarini neurologopedik nuqtai nazardan tashxislash, innervatsiya buzilishlari va zamonaviy korreksiya usullari.',
    descriptionRu: '8-недельный курс: углубленная неврологопедическая диагностика и методы устранения тяжелых речевых нарушений.',
    badge: 'Neurologopediya (PhD)',
    badgeRu: 'Неврологопедия (PhD)'
  },

  // ==================== LOGOPED CITY O‘QUV KURSLARI / BITIRUVCHILAR (9 ta) ====================
  {
    ...
    issueDate: '140 soat (Kurs rahbari: Aziza Atadjanova)',
  ...
  {
    id: 'cert-lc-matnazarova-ozoda',
    specialistId: 'spec-logoped-city',
    specialistName: 'Matnazarova Ozoda Bozorboyevna',
    specialistNameRu: 'Матназарова Озода Бозорбоевна',
    specialistRole: 'Boshlang‘ich Defektolog (Logoped City kursi bitiruvchisi)',
    specialistRoleRu: 'Начальный дефектолог (Выпускник курса Logoped City)',
    title: 'Boshlang‘ich defektologiya bo‘yicha 140 soatlik malaka oshirish sertifikati',
    titleRu: 'Сертификат повышения квалификации по начальной дефектологии (140 часов)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000175)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000175)',
    issueDate: '140 soat, 18.08.2026',
    imageUrl: '/certificates/logoped-city-matnazarova-ozoda.jpg',
    description: 'Logoped City MChJ o‘quv markazining 140 soatlik Boshlang‘ich defektologiya kursini muvaffaqiyatli tamomlaganligi to‘g‘risida rasmiy sertifikat.',
    descriptionRu: 'Сертификат об успешном окончании 140-часового курса «Начальная дефектология» в учебном центре Logoped City.',
    badge: 'Defektologiya (140s)',
    badgeRu: 'Дефектология (140ч)'
  },
  {
    id: 'cert-lc-tangriberganova-muammoli-xulq',
    specialistId: 'spec-logoped-city',
    specialistName: 'Tangriberganova Inobat Komiljanovna',
    specialistNameRu: 'Тангриберганова Инобат Комилжановна',
    specialistRole: 'Logoped City Mutaxassisi',
    specialistRoleRu: 'Специалист Logoped City',
    title: 'Muammoli xulq-atvor bilan ishlash va hamkorlik qilish',
    titleRu: 'Работа с проблемным поведением и сотрудничество',
    type: 'certificate',
    issuer: '«Autizm va Mehr» (Rasulov Islom)',
    issuerRu: '«Autizm va Mehr» (Расулов Ислом)',
    issueDate: '25.06.2026',
    imageUrl: '/certificates/tangriberganova-inobat-muammoli-xulq.jpg',
    description: 'Bolalarda muammoli xulq-atvorni bartaraf etish, pozitiv motivatsiya va o‘rganish ko‘nikmalarini rivojlantirish amaliy seminari.',
    descriptionRu: 'Практический семинар по коррекции нежелательного поведения и формированию сотрудничества у детей.',
    badge: 'Xulq-atvor Korreksiyasi',
    badgeRu: 'Коррекция поведения'
  },
  {
    id: 'cert-lc-tangriberganova-nutqsiz-bolalar',
    specialistId: 'spec-logoped-city',
    specialistName: 'Tangriberganova Inobat Komiljanovna',
    specialistNameRu: 'Тангриберганова Инобат Комилжановна',
    specialistRole: 'Logoped City Mutaxassisi',
    ...
    titleRu: 'Сотрудничество и запуск речи у неговорящих детей',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 0000138)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 0000138)',
    issueDate: '19.04.2026',
    imageUrl: '/certificates/tangriberganova-inobat-nutqsiz-bolalar.jpg',
    description: 'Nutqsiz bolalarda ilk taqlid, muloqot istagi va nutq faolligini oshirish bo‘yicha intensiv master-klass sertifikati.',
    descriptionRu: 'Сертификат мастер-класса по запуску речи и развитию коммуникативных навыков у неговорящих детей.',
    badge: 'Nutqni uyg‘otish',
    badgeRu: 'Запуск речи'
  },
  {
    id: 'cert-lc-tangriberganova-defektologiya-1',
    specialistId: 'spec-logoped-city',
    specialistName: 'Tangriberganova Inobat Komiljanovna',
    specialistNameRu: 'Тангриберганова Инобат Комилжановна',
    specialistRole: 'Logoped City Mutaxassisi',
    ...
    titleRu: 'Начальный курс дефектологии (1 модуль, 72 часа)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000027)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000027)',
    issueDate: '72 soat, 30.03.2026',
    imageUrl: '/certificates/tangriberganova-inobat-defektologiya-1.jpg',
    description: 'Defektologiya fanining asosiy tamoyillari, diagnostika usullari va korreksion pedagogika bo‘yicha 72 soatlik kurs.',
    descriptionRu: 'Курс дефектологии (1 модуль): принципы диагностики развития и современные коррекционные методики.',
    badge: 'Defektologiya 1-modul',
    badgeRu: 'Дефектология 1-модуль'
  },
  {
    id: 'cert-lc-tangriberganova-logopediya-asoslari',
    specialistId: 'spec-logoped-city',
    specialistName: 'Tangriberganova Inobat Komiljanovna',
    specialistNameRu: 'Тангриберганова Инобат Комилжановна',
    specialistRole: 'Logoped City Mutaxassisi',
    specialistRoleRu: 'Специалист Logoped City',
    title: 'Logopediya asoslari: diagnostikadan korreksiyagacha (140 soat)',
    titleRu: 'Основы логопедии: от диагностики до коррекции (140 часов)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000172)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000172)',
    issueDate: '140 soat, 01.08.2026',
    imageUrl: '/certificates/tangriberganova-inobat-logopediya-asoslari.jpg',
    description: '140 soatlik to‘liq logopediya kursi: nutq apparati buzilishlarini differensial diagnostika qilish va kompleks korreksiya dasturi.',
    descriptionRu: 'Полный 140-часовой курс логопедии: дифференциальная диагностика и комплексные методики коррекции речевых нарушений.',
    badge: 'Logopediya (140s)',
    badgeRu: 'Логопедия (140ч)'
  },
  {
    id: 'cert-lc-otaboyeva-nutqsiz-bolalar',
    specialistId: 'spec-logoped-city',
    specialistName: 'Otaboyeva Mohira Qudrat qizi',
    specialistNameRu: 'Отабоева Мохира Кудрат кизи',
    specialistRole: 'Logoped City Kursi Bitiruvchisi',
    specialistRoleRu: 'Выпускник курса Logoped City',
    title: 'Nutqsiz bolalarda hamkorlik va nutqni uyg‘otish',
    titleRu: 'Сотрудничество и запуск речи у неговорящих детей',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 0000142)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 0000142)',
    issueDate: '19.04.2026',
    imageUrl: '/certificates/otaboyeva-mohira-nutqsiz-bolalar.jpg',
    description: 'Otaboyeva Mohira Qudrat qiziga «Nutqsiz bolalarda hamkorlik va nutqni uyg‘otish» amaliy master-klassida ishtirok etgani uchun berilgan sertifikat.',
    descriptionRu: 'Сертификат выдан Отабоевой Мохире за участие в мастер-классе «Сотрудничество и запуск речи у неговорящих детей».',
    badge: 'Nutqni uyg‘otish',
    badgeRu: 'Запуск речи'
  },
  {
    id: 'cert-lc-otaboyeva-logopediya-1',
    specialistId: 'spec-logoped-city',
    specialistName: 'Otaboyeva Mohira Qudrat qizi',
    specialistNameRu: 'Отабоева Мохира Кудрат кизи',
    specialistRole: 'Logoped City Kursi Bitiruvchisi',
    ...
    titleRu: 'Начальный курс логопедии (1 модуль, 72 часа)',
    type: 'certificate',
    issuer: '«LOGOPED CITY» MChJ (Sertifikat № 000011)',
    issuerRu: 'ООО «LOGOPED CITY» (Сертификат № 000011)',
    issueDate: '72 soat, 30.03.2026',
    imageUrl: '/certificates/otaboyeva-mohira-logopediya-1.jpg',
    description: 'Logoped City o‘quv markazining 72 soatlik 1-modul boshlang‘ich logopediya kursini muvaffaqiyatli yakunlaganlik sertifikati.',
  ...
  // ==================== OLLABERGANOV OYBEK (5 ta) ====================
  {
    ...
    specialistRole: 'Sensor Integratsiya Mutaxassisi',
    specialistRoleRu: 'Специалист по сенсорной интеграции',
  ...
  {
    id: 'cert-oybek-muammoli-xulq-atvor',
    specialistId: 'spec-oybek',
    specialistName: 'Ollaberganov Oybek',
    specialistNameRu: 'Оллаберганов Ойбек',
    specialistRole: 'Sensor Integratsiya Mutaxassisi',
    ...
    issuerRu: '«Autizm va Mehr» (Расулов Ислом)',
    issueDate: '25.06.2026',
    imageUrl: '/certificates/oybek-ollaberganov-muammoli-xulq-atvor.jpg',
    description: 'Autizm va sensor buzilishlari bo‘lgan bolalarda muammoli xulq-atvor omillarini aniqlash, korreksiya qilish va sensor xonada hamkorlik o‘rnatish.',
    descriptionRu: 'Практический семинар по анализу проблемного поведения и установлению сотрудничества с детьми с аутизмом.',
    badge: 'Xulq-atvor Korreksiyasi',
    badgeRu: 'Коррекция поведения'
  },
  {
    id: 'cert-oybek-sensor-integratsiya-logostudio',
    specialistId: 'spec-oybek',
    specialistName: 'Ollaberganov Oybek',
    specialistNameRu: 'Оллаберганов Ойбек',
    specialistRole: 'Sensor Integratsiya Mutaxassisi',
    specialistRoleRu: 'Специалист по сенсорной интеграции',
    title: 'Sensor integratsiya nazariyasi va amaliyoti trening kursi',
    titleRu: 'Тренинг по теории и практике сенсорной интеграции',
    type: 'certificate',
    issuer: 'LogoStudio o‘quv markazi (Baxadirova M., Turdiboyeva N.)',
    issuerRu: 'Учебный центр LogoStudio (Бахадирова М., Турдибоева Н.)',
    issueDate: '20 o‘quv soati, 2026-yil',
    imageUrl: '/certificates/oybek-ollaberganov-sensor-integratsiya-logostudio.jpg',
    description: 'Taktil, vestibulyar va propriotseptiv sensor tizimlarni rivojlantirish, sensor disfunksiyalarni korreksiyalash bo‘yicha 20 soatlik amaliy kurs.',
    descriptionRu: '20-часовой тренинг: сенсорная интеграция, работа с вестибулярной и проприоцептивной системами.',
    badge: 'Sensor Integratsiya (20s)',
    badgeRu: 'Сенсорная интеграция (20ч)'
  },
  {
    id: 'cert-oybek-kleks-sensor-modul-1',
    specialistId: 'spec-oybek',
    specialistName: 'Ollaberganov Oybek',
    specialistNameRu: 'Оллаберганов Ойбек',
    specialistRole: 'Sensor Integratsiya Mutaxassisi',
    specialistRoleRu: 'Специалист по сенсорной интеграции',
    title: 'Sensor integratsiya jarayonlari nazariyasi va terapiyasi. 1-modul',
    titleRu: 'Теория и терапия процессов сенсорной интеграции. 1-й модуль',
    type: 'certificate',
    issuer: 'KLEKS Markazi (Polsha) & Logo Trening (Agneshka Lemanska)',
    issuerRu: 'Центр KLEKS (Польша) и Logo Trening (Агнешка Леманска)',
    issueDate: '20 soat, 06-07.06.2026',
    imageUrl: '/certificates/oybek-ollaberganov-kleks-sensor-modul-1.jpg',
    description: 'Polshaning yetakchi mutaxassislari tomonidan o‘tkazilgan sensor integratsiya terapiyasi bo‘yicha xalqaro sertifikat (1-modul, 20 soat).',
    descriptionRu: 'Международный сертификат 1-го модуля: теория и терапия процессов сенсорной интеграции от польского центра KLEKS.',
    badge: 'KLEKS Polsha (1-Modul)',
    badgeRu: 'KLEKS Польша (1-Модуль)'
  },
  {
    id: 'cert-oybek-kleks-sensor-modul-2',
    specialistId: 'spec-oybek',
    specialistName: 'Ollaberganov Oybek',
    specialistNameRu: 'Оллаберганов Ойбек',
    specialistRole: 'Sensor Integratsiya Mutaxassisi',
    specialistRoleRu: 'Специалист по сенсорной интеграции',
    title: 'Sensor integratsiya: diagnostika va terapiyaning amaliy jihatlari. 2-modul',
    titleRu: 'Сенсорная интеграция: диагностика и практика терапии. 2-й модуль',
    type: 'certificate',
    issuer: 'KLEKS Markazi (Polsha) & Logo Trening (Agneshka Lemanska)',
    issuerRu: 'Центр KLEKS (Польша) и Logo Trening (Агнешка Леманска)',
    issueDate: '20 soat, 13-14.06.2026',
    imageUrl: '/certificates/oybek-ollaberganov-kleks-sensor-modul-2.jpg',
    description: 'Sensor integratsiya bo‘yicha 2-modul xalqaro kursi: sensor profil tuzish, sensor diagnostika va klinik amaliyot (20 soat).',
    descriptionRu: 'Международный сертификат 2-го модуля: углубленная диагностика, построение сенсорного профиля и терапия.',
    badge: 'KLEKS Polsha (2-Modul)',
    badgeRu: 'KLEKS Польша (2-Модуль)'
  }
];
...
export const TARIFF_PLANS: TariffPlan[] = [
  ...
  },
  {
    ...
    lessonsSummary: 'Oyiga 30 ta mashg‘ulot (24 logoped + 3 basseyn + 3 ot sporti)',
    lessonsSummaryRu: '30 занятий в месяц (24 логопед + 3 бассейна + 3 иппотерапии)',
    price: '2 990 000',
    ...
    features: [
      '24 ta individual logopedik mashg‘ulot',
      '3 ta basseyn mashg‘uloti',
      '3 ta ot sporti / ippoterapiya',
      'Boshlang‘ich diagnostika',
      'Individual rivojlanish dasturi',
      'Oylik natija monitoringi',
    ...
    featuresRu: [
      ...
      '3 занятия конным спортом / иппотерапия',
      'Первичная диагностика',
      'Индивидуальная программа развития',
      'Ежемесячный мониторинг результатов',
  ...
  },
  {
    ...
    lessonsSummary: 'Oyiga 36+ ta mashg‘ulot (24 logoped + 6 basseyn + 6 ot sporti + transfer)',
    lessonsSummaryRu: '36+ занятий в месяц (24 логопед + 6 бассейнов + 6 иппотерапий + трансфер)',
    price: '4 990 000',
    ...
    features: [
      '24 ta individual logopedik mashg‘ulot',
      '6 ta basseyn mashg‘uloti',
      '6 ta ot sporti / ippoterapiya',
    ...
    featuresRu: [
      '24 индивидуальных логопедических занятия',
      '6 занятий в бассейне',
      '6 занятий конным спортом / иппотерапия',
